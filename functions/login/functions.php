...
if(!function_exists('ldc_use_custom_logo')){
    function ldc_use_custom_logo($attachment_id = 0){
...
if(!function_exists('ldc_use_local_header')){
    function ldc_use_local_header(){
